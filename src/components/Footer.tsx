        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-white/10 hover:bg-accent/20 p-3 rounded-lg transition-custom group" aria-label={t('social.facebook')}>
                <svg className="w-6 h-6 text-white/70 group-hover:text-accent transition-custom" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="#" className="bg-white/10 hover:bg-accent/20 p-3 rounded-lg transition-custom group" aria-label={t('social.instagram')}>
                <svg className="w-6 h-6 text-white/70 group-hover:text-accent transition-custom" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="bg-green-500/20 hover:bg-green-500/30 p-3 rounded-lg transition-custom group"
                aria-label="WhatsApp"
              >
                <svg className="w-6 h-6 text-green-300 group-hover:text-green-200 transition-custom" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <address className="not-italic space-y-3 text-white/80">
              <div className="flex items-start">
                ...
                <div>
                  <p>{tContact('address.street')}</p>
                  <p>{tContact('address.city')}</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:info@cevizplus.com" className="hover:text-accent transition-custom">
                  info@cevizplus.com
                </a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="tel:+901234567890" className="hover:text-accent transition-custom">
                  +90 (123) 456-7890
                </a>
              </div>
