          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              ...
              <div className="flex items-center justify-center bg-white/60 px-4 py-3 rounded-lg">
                ...
                <span className="font-medium text-foreground">Hızlı Teslimat</span>
              </div>
              <div className="flex items-center justify-center bg-white/60 px-4 py-3 rounded-lg">
                <svg className="w-5 h-5 text-primary mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span className="font-medium text-foreground">Uzman Desteği</span>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-primary/10">
              <p className="text-sm text-foreground/60 mb-4">Binlerce müşterimiz tarafından tercih ediliyor</p>
              <div className="flex items-center justify-center space-x-6 text-sm text-foreground/70">
                ...
                <div>20+ Yıl Deneyim</div>
                <div className="hidden sm:block w-px h-4 bg-primary/20"></div>
                <div>5000+ Mutlu Müşteri</div>
              </div>
            </div>
          </div>
        </div>
